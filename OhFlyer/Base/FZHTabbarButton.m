...
const double FZHTabBarImageRatio = 0.5;
...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self setTitleColor:RGBCOLOR(0, 52, 93) forState:UIControlStateSelected];
        [self setTitleColor:RGBACOLOR(0, 0, 0, 0.3) forState:UIControlStateNormal];
