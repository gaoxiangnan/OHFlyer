...
+(UIView *)ShowLocationImageScrollWithFream:(CGRect)rect andImageArray:(NSArray *)array andBtnClick:(BtnClickBlock)btnClick
{
    ...
    [selfImageScroll ShowImageScrollWithImageArray:array andBtnClick:btnClick andShowImageStyle:ImageShowStyleLocation rect:rect];
...
{
    WTImageScroll *selfImageScroll=[[WTImageScroll alloc]initWithFrame:rect];
    [selfImageScroll ShowImageScrollWithImageArray:array andBtnClick:btnClick andShowImageStyle:ImageShowStyleNetwork rect:rect];
    return selfImageScroll;
}
...
//控制显示
-(void)ShowImageScrollWithImageArray:(NSArray *)array andBtnClick:(BtnClickBlock)btnClick andShowImageStyle:(ImageShowStyle)showStyle rect:(CGRect)rect
{
    ...
    myScroll.contentSize=CGSizeMake(self.bounds.size.width*(array.count+2), rect.size.height);
...
//    pageView.pageIndicatorTintColor=[UIColor grayColor];
    ...
    [pageView setValue:[UIImage imageNamed:@"page_nomal"] forKeyPath:@"currentPageImage"];
    [pageView setValue:[UIImage imageNamed:@"page_selected"] forKeyPath:@"pageImage"];
    
    CGSize pointSize = [pageView sizeForNumberOfPages:array.count];
    CGFloat page_x = -(pageView.bounds.size.width - pointSize.width) / 2 ;
    
    
    [pageView setBounds:CGRectMake(page_x+20, pageView.bounds.origin.y, pageView.bounds.size.width, pageView.bounds.size.height)];
