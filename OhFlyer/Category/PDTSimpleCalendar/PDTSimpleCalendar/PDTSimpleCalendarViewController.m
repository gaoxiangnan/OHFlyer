...
//        NSDateComponents *components = [self.calendar components:kCalendarUnitYMD
//                                                        fromDate:[[NSDate date] initWithTimeIntervalSinceNow: 24*60*60*1]];
...
- (void)viewDidLoad
{
    ...
    NSInteger weekdayHeaderHeight =  PDTSimpleCalendarWeekdayHeaderHeight;
...
{
//    NSDate *myDate = [self.firstDate initWithTimeIntervalSinceNow:60*60*24];
