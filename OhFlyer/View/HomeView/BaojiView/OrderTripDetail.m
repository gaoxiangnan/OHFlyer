...
@end
@implementation OrderTripDetail
...
- (void)InitWithSubViews
{
    ...
    [_showDateImg mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(_startLb.mas_bottom).offset(30);
    }];
    ...
    [_seatNum mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(_bgView).offset(53);
    ...
    [_lineSeat mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(_bgView).offset(kDeviceWidth/3+15);
    ...
    [_lineTime mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(_lineSeat).offset((kDeviceWidth-20)/3);
    ...
    CGPathMoveToPoint(path, NULL, 20, 101);
    CGPathAddLineToPoint(path, NULL, kScaleFrom_iPhone5s_Desgin(325),101);
    
    // 0,10代表初始坐标的x，y
    // 320,10代表初始坐标的x，y
    CGPathMoveToPoint(path, NULL, 20, 53);
    CGPathAddLineToPoint(path, NULL, kScaleFrom_iPhone5s_Desgin(325),50);
